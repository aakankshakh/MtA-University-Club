    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-h-[calc(100vh-100px)] overflow-y-auto w-full sm:w-1/2 relative">
      ...
      <div className="container mx-auto">
        ...
        {isProcessing ? (
          ...
          <button
            className={`rounded-md bg-red-900 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-900 ${!isOrderTypeSelected() && "opacity-50 cursor-not-allowed"}`}
