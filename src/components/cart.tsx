    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-800 dark:bg-gray-900 bg-opacity-50 flex justify-center items-center">
      {!orderPlaced ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-h-[calc(100vh-100px)] overflow-y-auto w-full sm:w-1/2 relative">
          <button
            className="absolute top-0 right-0 m-4 text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400"
            onClick={onClose}
          >
            Close
          </button>
          ...
          <div className="container mx-auto">
            {cartItems.map((cartItem, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 mb-4"
              >
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                  ...
                  <div className="flex items-center">
                    <button
                      className="bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-white px-2 py-1 rounded-full mr-2"
                    ...
                    <button
                      className="bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-white px-2 py-1 rounded-full ml-2"
            ...
            <div className="font-bold text-xl mb-4 text-gray-900 dark:text-white">
